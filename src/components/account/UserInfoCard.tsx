...
type HandleKey = "solvedAc" | "codeforces" | "atcoder" | "doj" | "qoj" | "jungol";

// solved.ac/Codeforces/AtCoder/DOJ/QOJ/정올 핸들 — 본인이 직접 볼 수도, 연필 아이콘으로
// 바로 고칠 수도 있습니다(이름/이메일/학번과 달리 신원 정보가 아니라서 본인 수정 허용 —
